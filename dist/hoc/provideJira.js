...
var provideJira = function provideJira(Component) {
  ...
  return _temp = _class = /*#__PURE__*/function (_ReactComponent) {
    ...
    function TestProvider() {
      ...
      _defineProperty(_assertThisInitialized(_this), "onAddJiraTickets", function (_ref) {
        var kind = _ref.kind,
    ...
    _createClass(TestProvider, [{
      ...
      value: function componentDidMount() {
        ...
        api.on(_constants.ADD_JIRA_TICKETS, this.onAddJiraTickets);
      }
    }, {
      ...
      value: function componentWillUnmount() {
        ...
        api.off(_constants.ADD_JIRA_TICKETS, this.onAddJiraTickets);
      }
    }, {
      key: "render",
